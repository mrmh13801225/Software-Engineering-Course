...
public class NewMinQuantityTest {
    @Autowired
    ...
    void does_not_match_because_not_satisfying_min_execution_and_rollback_on_buyer() { //fail
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 1, LocalDateTime.now(), Side.BUY, 304, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 305));
    ...
    void does_not_match_because_not_satisfying_min_execution_and_rollback_on_seller() { //2
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 3, LocalDateTime.now(), Side.SELL, 320, 520, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 330));
    ...
    void does_not_match_because_negative_min_execution_and_rollback_on_buyer() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 1, LocalDateTime.now(), Side.BUY, 304, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0, -100));
    ...
    void does_not_match_because_negative_min_execution_and_rollback_on_seller() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 3, LocalDateTime.now(), Side.SELL, 100, 520, broker3.getBrokerId(), shareholder.getShareholderId(), 0, -200));
    ...
    void update_buyer_min_execution_quantity_does_not_match() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 1, LocalDateTime.now(), Side.BUY, 304, 570, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 301));
    ...
    void update_seller_min_execution_quantity_does_not_match() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 6, LocalDateTime.now(), Side.SELL, 350, 580, broker1.getBrokerId(), shareholder.getShareholderId(), 0, 1));
    ...
    void update_buy_order_and_do_not_change_min_quantity() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 3, LocalDateTime.now(), Side.BUY, 440, 545, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 1));
    ...
    void update_sell_order_and_do_not_change_min_quantity() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 6, LocalDateTime.now(), Side.SELL, 350, 580, broker1.getBrokerId(), shareholder.getShareholderId(), 0, 120));
