...
//    }
    ...
    void invalid_new_order_with_tick_and_lot_size_errors() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "XXX", 1, LocalDateTime.now(), Side.SELL, 12, 1001, 1, shareholder.getShareholderId(), 0));
        ArgumentCaptor<OrderRejectedEvent> orderRejectedCaptor = ArgumentCaptor.forClass(OrderRejectedEvent.class);
        verify(eventPublisher).publish(orderRejectedCaptor.capture());
        OrderRejectedEvent outputEvent = orderRejectedCaptor.getValue();
        assertThat(outputEvent.getOrderId()).isEqualTo(1);
    ...
    void update_order_causing_no_trades() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.SELL, 1000, 15450, 1, shareholder.getShareholderId(), 0));
    ...
    void handle_valid_update_with_trades() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.SELL, 1000, 15450, broker2.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void invalid_update_with_multiple_errors() {
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "XXX", -1, LocalDateTime.now(), Side.SELL, 0, 0, -1, shareholder.getShareholderId(), 0));
        ArgumentCaptor<OrderRejectedEvent> orderRejectedCaptor = ArgumentCaptor.forClass(OrderRejectedEvent.class);
        verify(eventPublisher).publish(orderRejectedCaptor.capture());
        OrderRejectedEvent outputEvent = orderRejectedCaptor.getValue();
        assertThat(outputEvent.getOrderId()).isEqualTo(-1);
    ...
    void buyers_credit_decreases_on_new_order_without_trades() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.BUY, 30, 100, 10, shareholder.getShareholderId(), 0));
    ...
    void buyers_credit_decreases_on_new_iceberg_order_without_trades() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.BUY, 30, 100, 10, shareholder.getShareholderId(), 10));
        assertThat(broker.getCredit()).isEqualTo(10_000-30*100);
    }
    ...
    void credit_does_not_change_on_invalid_new_order() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", -1, LocalDateTime.now(), Side.BUY, 30, 100, broker.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void credit_updated_on_new_order_matched_partially_with_two_orders() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.BUY, 100, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_buy_order_changing_price_with_no_trades_changes_buyers_credit() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 100, LocalDateTime.now(), Side.BUY, 30, 550, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_sell_order_changing_price_with_no_trades_does_not_changes_sellers_credit() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 100, LocalDateTime.now(), Side.SELL, 30, 550, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_order_changing_price_with_trades_changes_buyers_and_sellers_credit() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 2, LocalDateTime.now(), Side.BUY, 500, 590, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_order_without_trade_decreasing_quantity_changes_buyers_credit() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 2, LocalDateTime.now(), Side.BUY, 400, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void new_sell_order_without_enough_positions_is_rejected() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.SELL, 400, 590, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_sell_order_without_enough_positions_is_rejected() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 6, LocalDateTime.now(), Side.SELL, 450, 580, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_sell_order_with_enough_positions_is_executed() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, "ABC", 6, LocalDateTime.now(), Side.SELL, 250, 570, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void new_buy_order_does_not_check_for_position() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 200, LocalDateTime.now(), Side.BUY, 500, 570, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void update_buy_order_does_not_check_for_position() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 3, LocalDateTime.now(), Side.BUY, 500, 545, broker3.getBrokerId(), shareholder1.getShareholderId(), 0));
