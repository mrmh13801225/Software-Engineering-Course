...
public class OrderHandlerTest {
    ...
    void update_buyer_min_execution_quantity_does_not_match() {
        ...
        orderHandler.handleEnterOrder(EnterOrderRq.createUpdateOrderRq(1, "ABC", 3, LocalDateTime.now(), Side.BUY, 304, 570, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 400));
