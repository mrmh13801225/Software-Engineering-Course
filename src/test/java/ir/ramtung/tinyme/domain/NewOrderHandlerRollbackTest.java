...
@DirtiesContext
public class NewOrderHandlerRollbackTest {
    @Autowired
    ...
    void new_order_from_buyer_with_not_enough_credit_based_on_trades() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, security.getIsin(), 200, LocalDateTime.now(), Side.BUY, 100, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void new_order_from_buyer_with_not_enough_credit_based_on_trades_with_iceberg_orders() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, security.getIsin(), 200, LocalDateTime.now(),
    ...
    void update_order_from_buyer_with_not_enough_credit_based_on_trades_with_iceberg_orders() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateOrderRq(1, security.getIsin(), 4, LocalDateTime.now(),
                Side.BUY, 60, 1545, broker3.getBrokerId(), shareholder.getShareholderId(), 0));
