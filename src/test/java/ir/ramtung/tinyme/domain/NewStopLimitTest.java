...
import ir.ramtung.tinyme.domain.service.NewOrderHandler;
...
public class NewStopLimitTest {
    ...
    void create_new_seller_stop_limit_order_successfully() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 570));
    ...
    void create_new_buyer_stop_limit_order_successfully() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.BUY, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 450));
        verify(eventPublisher).publish(any(OrderAcceptedEvent.class));
    }
    ...
    void update_buyer_stop_price_when_stop_limit_is_passive() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.BUY, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 490));
    ...
    void update_seller_stop_price_when_stop_limit_is_passive() {
        ...
        security.getStopLimitOrderBook().enqueue(order1);
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 490));
        verify(eventPublisher).publish(any(OrderUpdatedEvent.class));
    }
    ...
    void update_stop_price_when_stop_price_is_active() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 450));
        verify(eventPublisher).publish(any(OrderAcceptedEvent.class));


        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 480));
    ...
    void update_min_quantity_of_stop_limit_order() {
        ...
        StopLimitOrder order1 = new StopLimitOrder(8, security, Side.SELL, 230, 500, broker3, shareholder, 0, 450); //stoplimit
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 100, 450));
        verify(eventPublisher).publish(any(OrderRejectedEvent.class));
    ...
    void update_seller_stoplimit_order_with_peaksize() {
        StopLimitOrder order1 = new StopLimitOrder(8, security, Side.SELL, 230, 500, broker3, shareholder, 0, 450); //stoplimit
        security.getStopLimitOrderBook().enqueue(order1);
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 90, 490));
        verify(eventPublisher).publish(any(OrderRejectedEvent.class));
    ...
    void update_buyer_stoplimit_order_with_peaksize() {
        StopLimitOrder order1 = new StopLimitOrder(8, security, Side.BUY, 230, 500, broker3, shareholder, 0, 450); //stoplimit
        security.getStopLimitOrderBook().enqueue(order1);
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.BUY, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 90, 490));
        verify(eventPublisher).publish(any(OrderRejectedEvent.class));
        verify(eventPublisher).publish(new OrderRejectedEvent(1, 8, List.of(Message.STOP_LIMIT_ORDER_CANNOT_BE_ICEBERG)));
    }
    ...
    void when_stop_price_is_active_it_will_activate_all_stop_limit_orders_with_the_same_stop_price() {
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 22, LocalDateTime.now(), Side.SELL, 20, 400, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
    ...
    void delete_stop_limit_order_when_stop_price_is_passive() {     ///should I separate buyer and seller?
        ...
        security.getStopLimitOrderBook().enqueue(stopLimitOrder1);
        orderHandler.handleRequest(new DeleteOrderRq(2, "ABC", Side.SELL, 8));
    ...
    void delete_stop_limit_order_when_stop_price_is_active() {
        ...
        security.getOrderBook().enqueue(buyOrder1);
        broker2.increaseCreditBy(1000_000);
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 100, LocalDateTime.now(), Side.SELL, 30, 400, broker1.getBrokerId(), shareholder.getShareholderId(), 0));
        verify(eventPublisher).publish(new OrderAcceptedEvent(1, 100));
        orderHandler.handleRequest(EnterOrderRq.createNewStopLimitOrderRq(8, "ABC", 8, LocalDateTime.now(), Side.SELL, 230, 500, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 550));
    ...
    void new_stop_limit_order_with_min_quantity() {
        StopLimitOrder order1 = new StopLimitOrder(8, security, Side.BUY, 230, 500, broker3, shareholder, 0, 450); //stoplimit
        orderHandler.handleRequest(EnterOrderRq.createUpdateStopLimitOrderRq(1, "ABC", 8, LocalDateTime.now(), Side.BUY, 230, 500, broker2.getBrokerId(), shareholder.getShareholderId(), 0, 30, 450));
        verify(eventPublisher).publish(any(OrderRejectedEvent.class));
        verify(eventPublisher).publish(new OrderRejectedEvent(1, 8, List.of(Message.STOP_LIMIT_ORDER_CANNOT_HAVE_MIN_EXEC)));
    }
    ...
    void stop_limit_order_activated_from_beginning(){
        ...
        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(1, "ABC", 1, LocalDateTime.now(),
                Side.BUY, 10, 100, broker1.getBrokerId(), shareholder.getShareholderId(), 0));

        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(2, "ABC", 2, LocalDateTime.now(),
                Side.BUY, 10, 110, broker1.getBrokerId(), shareholder.getShareholderId(), 0));

        orderHandler.handleRequest(EnterOrderRq.createNewOrderRq(4, "ABC", 4, LocalDateTime.now(),
                Side.SELL, 5, 100, broker2.getBrokerId(), shareholder.getShareholderId(), 0));

        orderHandler.handleRequest(EnterOrderRq.createNewStopLimitOrderRq(3 , "ABC", 3,
